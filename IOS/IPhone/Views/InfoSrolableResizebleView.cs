	...
	namespace UI
	{
		public class InfoSrolableResizebleView : UIScrollView
		{
			...
			public override void LayoutSubviews ()
			{
				...
				_logoImageView.SetRoundedFrame (x: Bounds.Width / 2 - _logoImageView.Bounds.Width / 2, 
				                               y: 10, 
				                               size: _logoImageView.Bounds.Size);

				_infoText.SetRoundedFrame (x: _leftAndRigthOffsets, 
				                          y: _logoImageView.Bounds.Bottom + 30, 
				                          width: Bounds.Width - _leftAndRigthOffsets * 2, 
				                          height: 200);
				_infoText.SizeToFit ();
